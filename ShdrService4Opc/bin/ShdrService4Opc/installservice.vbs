...
dim servicename :  servicename  = "ShdrService4Opc"
dim servicepath :  servicepath  = "C:\ShdrService4Opc\"
...
sCmd = "sc.exe failure " & servicename    & "reset= 3600 reboot= " & Chr(34) & "Restarting " & servicename  & Chr(34) & " actions= restart/5000/restart/5000/restart/5000"
run sCmd
